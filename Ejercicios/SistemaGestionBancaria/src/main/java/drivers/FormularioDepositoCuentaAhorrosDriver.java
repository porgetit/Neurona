...
import views.forms.FormularioDepositoCuentaAhorros;
 ...
 */
public class FormularioDepositoCuentaAhorrosDriver implements ActionListener{
    FormularioDepositoCuentaAhorros view;
    Cliente cliente;

    public FormularioDepositoCuentaAhorrosDriver(Cliente cliente) {
        this.view = new FormularioDepositoCuentaAhorros();
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (event == this.view.Depositar && this.view.Depositar.getText().equals("Depositar")) {
            ...
            this.cliente.getCuentaAhorros().depositar(monto);
            this.view.dispose();
